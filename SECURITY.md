...
`mailkube-laravel` follows [Semantic Versioning](https://semver.org/). Security
...
[**"Report a vulnerability"**](https://github.com/mailkube/mailkube-laravel/security/advisories/new)
